...
<div class="container mt-4">
    <h2>Hubungi Gweh</h2>
    <p>Silakan isi form di bawah ini untuk menghubungi saya ges.</p>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <strong>Alamat:</strong> Hatimu, Purbalingga, Jawa Tengah<br>
                        <strong>Email:</strong> raffaoktafian@student.telkomuniversity.ac.id<br>
