        ...
        <div class="col-md-12">
            <div class="p-5 mb-4 bg-light rounded-3">
                <div class="container-fluid py-5">
                    ...
                    <p class="col-md-8 fs-4">Pada website ini saya menggunakan HTML, CSS, Bootstrap, dan PHP.</p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Deskripsi fitur 2.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Deskripsi fitur 3.</p>
                </div>
            </div>
        </div>
    </div>
